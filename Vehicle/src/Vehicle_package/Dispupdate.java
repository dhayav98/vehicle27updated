...
public class Dispupdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Vehicle vv:list)
		{
			out.print("<tr><td>"+vv.getVehicleno()+"</td><td>"+vv.getBranch()+"</td><td>"+vv.getVehicletype()+"</td><td>"+vv.getInsurance_expiry()+"</td><td>"+vv.getLast_serviced_date()+"</td><td>"+vv.getService_due_date()+"</td><td><center><button class='updatebutton'><a href='Updatevehicle.jsp?vno="+vv.getVehicleno()+"'>Update</a></button></center></td></tr>");
		}
		out.print("</table>");
		out.print("<br>");
